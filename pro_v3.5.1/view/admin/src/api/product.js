...
/**
 * @description 商品属性 -- 获取等级列表
 */
export function productGetLevelListApi() {
  return request({
    url: `product/get_level_list`,
    method: 'get'
  });
}
 ...
 * @param {Object} param data {Object} 传值对象
 */
export function productRecommendSaveApi(data) {
  return request({
    url: `recommend/save`,
    method: 'post',
    data
 ...
 * @param {Object} param params {Object} 传值参数
 */
export function productRecommendListApi(params) {
  return request({
    url: `recommend/list`,
    method: 'get',
    params
...
/**
 * @description 获取推荐位详情
 * @param {Object} param id {Number} 推荐位id
 */
export function productRecommendInfoApi(id) {
  return request({
    url: `recommend/info/${id}`,
    method: 'get'
  });
}
...
export function productRecommendSetStatus(id ,status) {
  return request({
    url: `recommend/status/${id}/${status}`,
    method: 'post'
  });
}
 ...
 * @param {Object} param id {Number} 推荐位id
 */
export function productRecommendEditTitle(data) {
  return request({
    url: `recommend/edit_title`,
    method: 'post',
    data
  });
}