...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      name: `${pre}recommend`,
      meta: {
        auth: ["admin-storeProduct-recommend"],
        title: "商品推荐",
      },
      component: () => import("@/pages/product/recommend/index"),
    },
    {
      path: "recommend/create/:id?",
      name: `${pre}recommendCreate`,
      meta: {
        auth: ["admin-storeProduct-recommend-create"],
        title: "添加商品推荐",
      },
      component: () => import("@/pages/product/recommend/create"),
    },
  ],
};
