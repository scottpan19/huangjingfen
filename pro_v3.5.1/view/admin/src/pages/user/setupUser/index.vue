          ...
          <Row :gutter="24" type="flex">
            ...
            <Col span="24" class="mt10">
              <FormItem label="用户默认头像：">
                ...
                <div class="upload-text">建议尺寸120*120px</div>
              </FormItem>
            </Col>
            <Col span="24" class="mt10">
          ...
          <Row :gutter="24" type="flex">
                ...
                >
                  ...
                  >
                    ...
                    <template slot-scope="{ row, index }" slot="status">
                      <a @click="delCoupon(index, indexw, item.giveCoupon)"
                        >删除</a
                      >
                    </template>
                  </Table>
            ...
            >
              <FormItem label="折扣力度：">
                ...
                <div class="upload-text">折扣力度为0-100%，1折为10%</div>
              </FormItem>
            </Col>
            <Col
              span="24"
            ...
            >
              <FormItem label="折扣上限：">
                ...
                <div class="upload-text">首单优惠最高金额，单位元</div>
              </FormItem>
            </Col>
            <Col span="24" class="mt10" v-if="loginForm.newcomer_status === 1">
              ...
              <FormItem label="赠送优惠券：">
                ...
                >
                  ...
                  <Table
                    ...
                    width="700"
                    v-if="
                      vipForm.level_give_coupon.length &&
                      vipForm.level_coupon_status == 1
                    "
                  >
                    <template slot-scope="{ row }" slot="coupon_price">
                      <span v-if="row.coupon_type == 1">
                    ...
                    <template slot-scope="{ row, index }" slot="status">
                      <a
                        @click="
                          delCoupon(index, indexw, vipForm.level_give_coupon)
                        "
                        >删除</a
                      >
                    </template>
...
export default {
  ...
  watch: {
    "$route.path": {
      ...
      deep: true,
      immediate: true, // 可选是否在组件创建时立即执行一次
    },
  },
  ...
  methods: {
    ...
    getProductId(data) {
      ...
      const addKey = (uni) =>
        uni.map((item) => ({
          ...item,
          ativity_price: item.ativity_price,
