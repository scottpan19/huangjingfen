      ...
      <Row type="flex" align="middle">
        ...
        <Col span="20">
          <Form :model="batchData" :label-width="122" @submit.native.prevent>
            <!-- 批量设置 重置 增加 清除 -->
            <FormItem label="批量设置：" v-if="menuActive === 2">
              <RadioGroup v-model="label_type">
                <Radio :label="0">重置</Radio>
                <Radio :label="1">增加</Radio>
                <Radio :label="2">清除</Radio>
              </RadioGroup>
            </FormItem>
...
export default {
  ...
  methods: {
    ...
    userSearchs() {
      ...
      if (this.timeVal[0] && !this.userFrom.user_time_type) {
