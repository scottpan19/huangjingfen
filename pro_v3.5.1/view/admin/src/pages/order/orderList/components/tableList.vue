  ...
  <div>
    ...
    >
      ...
      <vxe-column
        ...
        min-width="150"
      ></vxe-column>
      <vxe-column field="pay_type_name" title="支付方式" min-width="150">
        <template v-slot="{ row }">
  ...
  methods: {
    ...
    printOreder() {
      ...
      let pathInfo = this.$router.resolve({
        path: this.isSupplier ? "/supplier/supplier/order/distribution" : "/admin/supplier/order/distribution",
        query: {
    ...
    getOnlyRefundData(id, refund_type, rowActive) {
      let rowData = this.splitOrderData.find(item=> item.id == id);
      let _info = rowData._info;
