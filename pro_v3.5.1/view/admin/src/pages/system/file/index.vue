          ...
          <div class="header">
            <div>
              <Button
                ...
                >上传图片</Button
              >
              <Button class="mr14 upload" v-else @click="uploadVideo"
                >上传视频</Button
              >
              <Button class="mr14" @click="selectAll">全选</Button>
              <Button
                class="mr14"
          ...
          <div ref="main" class="main">
            ...
            <div v-if="layout == 1" key="grid" class="acea-row conter">
              ...
              >
                  ...
                  <div class="picMenu">
                    ...
                    <Button @click="item.isEdit = !item.isEdit">
                     ...
                     <Poptip placement="bottom" trigger="hover" width="300" height="300" transfer>
                        <Button class="preview mx-8">查看</Button>
                        <div class="images" slot="content">
                          <img :src="item.satt_dir" alt="" class="w-full h-full block cover"/>
                        </div>
                      </Poptip>
                ...
                <div class="nameStyle" v-show="item.realName && item.real_name" @click="closePreview(item)">
