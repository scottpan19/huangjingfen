      ...
      <div class="flex-wrapper">
        ...
        <div class="right">
          <div class="content">
            ...
            <div class="content-box">
              <div class="left pr-14">强制昵称头像：</div>
              <div class="right">
            ...
            <div class="content-box">
              <div class="left pr-14">发货信息管理：</div>
              <div class="right">
            ...
            <div class="content-box">
              <div class="left pr-14">手机号获取方式：</div>
              <div class="right">
          ...
          <div class="content" style="margin-bottom: 60px;">
           ...
           <!-- <div class="content-box">
            ...
            <div class="content-box">
              <div class="left pr-14">小程序源码包：</div>
              <div class="right">
