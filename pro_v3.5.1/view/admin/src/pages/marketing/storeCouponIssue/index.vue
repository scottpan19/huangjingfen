      ...
      <div class="new_card_pd">
        ...
        >
          ...
          <FormItem label="优惠券名称：" label-for="coupon_title">
            ...
            />
            <Button type="primary" @click="orderSearch()" class="mr14"
              >查询</Button
            >
            <Button @click="reset()" class="mr14"
              >重置</Button
            >
          </FormItem>
        </Form>
...
export default {
  ...
  methods: {
    ...
    reset() {
      ...
      this.tableFrom.coupon_title = '';
      this.tableFrom.receive_type = '';
      this.tableFrom.coupon_type = '';
      this.getList();
    },
    // 添加优惠券
    add() {
    ...
    copy(data, isEdit) {
      this.$router.push({
        path: `/admin/marketing/store_coupon_issue/create/${data.id}/${isEdit}`,
      });
    },
    // 是否开启
    openChange(data) {
