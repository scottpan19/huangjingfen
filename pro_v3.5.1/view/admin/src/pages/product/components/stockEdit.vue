<template>
  ...
  >
    <Card :bordered="false" :padding="0" dis-hover class="cards">
      <Alert closable type="warning" @on-close="closeTip">
        完成出入库后，系统将自动生成一笔其他入库 / 出库单据，可于库存管理模块查看
      </Alert>
      <div class="batch" v-if="specType && goodsType != 6" :style="{'top': batchTop + 'px'}">
