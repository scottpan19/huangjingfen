    ...
    <div class="home_product">
      <div class="hd_nav" v-if="styleConfig == 0">
        ...
        >
          <p
            class="title"
            :style="{
              color: index == tabCur ? toneConfig ? textColor2 : colorStyle.theme : nameColor,
              fontSize: index == tabCur ? activeFontSize + 'px' : fontSize + 'px',
            }"
          >
      ...
      <div class="menus" :class="styleConfig == 2 ? 'on' : ''" v-else>
        <div
          ...
          :style="{
            color:
              index == tabCur ? (toneConfig ? textColor : '#333') : nameColor,
              fontSize: index == tabCur ? activeFontSize + 'px' : fontSize + 'px',
          }"
        >
          {{ item.chiild[0].val || "标题"
        ...
        <div
          ...
          :key="index"
          :style="{
            color: index == tabCur ? toneConfig ? textColor2: '#E93323': nameColor,
            fontSize: index == tabCur ? activeFontSize + 'px' : fontSize + 'px',
          }"
        >
          {{ item.chiild[0].val || "标题"
        ...
        <div
          ...
          :style="{
            color:
              index == tabCur ? (toneConfig ? textColor3 : '#fff') : nameColor,
            background:
  ...
  methods: {
    setConfig(data) {
      ...
      if (data.mbConfig) {
        ...
        this.activeFontSize = data.activeFontSize?.val;
