				...
				<view class="w-full fixed-lt z-99" :style="[navBarStyle]">
					<view class="w-full px-20 h-80 flex-between-center">
						...
						<view class="fixed rd-50-p111- flex-center opac"
							...
							v-if="diyProduct.openShare && isLogin"
							@tap="listenerActionSheet">
						<!-- #endif -->
						<!-- #ifndef MP -->
						<view class="w-60 h-60 rd-50-p111- flex-center opac" v-if="diyProduct.openShare && isLogin" @tap="listenerActionSheet">
						<!-- #endif -->
				...
				<view>
					...
					<view class="activity-card rd-t-40rpx relative w-full h-152 flex justify-between"
						...
						<view class="flex items-baseline text--w111-fff mt-8">
							...
							<baseMoney :money="attribute.productSelect.price" symbolSize="32" integerSize="56" decimalSize="32" color="#ffffff"></baseMoney>
							<baseMoney v-if="attribute.productSelect.ot_price" :money="attribute.productSelect.ot_price" symbolSize="32" integerSize="32" decimalSize="32" line color="#ffffff" class="ml-14"></baseMoney>
						</view>
					</view>
					<!-- 商品介绍卡片 -->
						...
						<view class="px-32">
							<view class="w-full pt-36">
								...
								<view class="flex-between-center mt-20 text--w111-999 fs-22 lh-30rpx">
									<text class="text-line" v-if="attribute.productSelect.ot_price || storeInfo.product_price">￥{{ attribute.productSelect.ot_price || storeInfo.product_price }}</text>
