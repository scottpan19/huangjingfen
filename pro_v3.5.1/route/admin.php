...
Route::group('adminapi', function () {
    ...
    Route::group('export', function () {
        ...
        //出入库导出
        Route::get('stockExport', 'v1.other.export.ExportExcel/stockExport')->option(['real_name' => '导出出入库记录']);
        //盘点导出
        Route::get('inventoryExport', 'v1.other.export.ExportExcel/inventoryExport')->option(['real_name' => '库存盘点导出']);
        //出入库明细
        Route::get('stockDetailsExport', 'v1.other.export.ExportExcel/stockDetailsExport')->option(['real_name' => '库存盘点导出']);
...
//            Route::post('push/create_task', 'v1.marketing.holiday.HolidayGift/createPushTask');
    ...
    Route::group('order', function () {
        ...
        //未发货订单修改地址
        Route::post('edit_address/:id', 'v1.order.StoreOrder/editAddress')->option(['real_name' => '修改地址']);
        //获取订单状态
    ...
    Route::group('product', function () {
        ...
        //获取等级列表
        Route::get('get_level_list', 'v1.product.StoreProduct/getLevelList')->option(['real_name' => '获取等级列表']);
    })->middleware([
        \app\http\middleware\AllowOriginMiddleware::class,
        \app\http\middleware\admin\AdminAuthTokenMiddleware::class,
        \app\http\middleware\admin\AdminCkeckRoleMiddleware::class,
    ...
    Route::group('stock', function () {
        //获取出入库记录列表
        Route::get('record/index', 'v1.product.stock.StockRecordController/index')->option(['real_name' => '获取出入库记录列表']);
        //创建出入库记录
        Route::post('record/save', 'v1.product.stock.StockRecordController/save')->option(['real_name' => '创建出入库记录']);
        //退款单查询
        Route::get('record/refund_list', 'v1.product.stock.StockRecordController/refundList')->option(['real_name' => '退款单查询']);
        //备注表单
        Route::get('record/remark/:id', 'v1.product.stock.StockRecordController/remark')->option(['real_name' => '备注表单']);
        //修改备注
        Route::post('record/remark_save/:id', 'v1.product.stock.StockRecordController/remarkSave')->option(['real_name' => '修改备注']);
        //获取出入库记录详情
        Route::get('record/read', 'v1.product.stock.StockRecordController/read')->option(['real_name' => '获取出入库记录详情']);
        //统计
        Route::get('statistics', 'v1.product.stock.StockRecordController/stockStatistics')->option(['real_name' => '获取库存统计']);
        //整体统计卡片
        Route::get('overall_statistics', 'v1.product.stock.StockRecordController/overallStatistics')->option(['real_name' => '获取出入库整体统计卡片']);

        //获取商品库存列表
        Route::get('product/list', 'v1.product.stock.StockRecordController/productList')->option(['real_name' => '获取商品库存列表']);
        //获取商品出入库明细
        Route::get('product/details', 'v1.product.stock.StockRecordController/stockDetails')->option(['real_name' => '获取商品出入库明细']);
        //获取商品出入库明细统计
        Route::get('product/statistics', 'v1.product.stock.StockRecordController/productStatistics')->option(['real_name' => '获取商品出入库明细统计']);

        //导出出入库记录
        Route::get('export', 'v1.product.stock.StockRecordController/export')->option(['real_name' => '导出出入库记录']);

        //获取出入库记录列表
        Route::get('inventory/index', 'v1.product.stock.StockInventoryController/index')->option(['real_name' => '获取出库存盘点列表']);
        //创建出入库记录
        Route::post('inventory/save', 'v1.product.stock.StockInventoryController/save')->option(['real_name' => '创建库存盘点记录']);
        Route::post('inventory/update/:id', 'v1.product.stock.StockInventoryController/update')->option(['real_name' => '创建库存盘点记录']);
        //备注表单
        Route::get('inventory/remark/:id', 'v1.product.stock.StockInventoryController/remark')->option(['real_name' => '库存盘点备注表单']);
        //修改备注
        Route::post('inventory/remark_save/:id', 'v1.product.stock.StockInventoryController/remarkSave')->option(['real_name' => '库存盘点修改备注']);
        //获取出入库记录详情
        Route::get('inventory/read/:id', 'v1.product.stock.StockInventoryController/read')->option(['real_name' => '获取出库存盘点记录详情']);
...
//            'update' => '修改供应商',
    ...
    Route::group('recommend', function () {
        //商品推荐列表
        Route::get('list', 'v1.system.SystemRecommend/getRecommendList')->option(['real_name' => '商品推荐列表']);
        //商品推荐修改标题
        Route::post('edit_title', 'v1.system.SystemRecommend/editRecommendTitle')->option(['real_name' => '商品推荐修改标题']);
        //商品推荐信息
        Route::get('info/:id', 'v1.system.SystemRecommend/getRecommendInfo')->option(['real_name' => '商品推荐信息']);
        //保存商品推荐
        Route::post('save', 'v1.system.SystemRecommend/saveRecommend')->option(['real_name' => '保存商品推荐']);
        //修改商品推荐状态
        Route::post('status/:id/:status', 'v1.system.SystemRecommend/setRecommendStatus')->option(['real_name' => '修改商品推荐状态']);
    })->middleware([
        \app\http\middleware\AllowOriginMiddleware::class,
        \app\http\middleware\admin\AdminAuthTokenMiddleware::class,
        \app\http\middleware\admin\AdminCkeckRoleMiddleware::class,
